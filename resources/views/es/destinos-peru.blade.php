            ...
            <div class="row w-100">
                <div class="col-lg-12 text-center">
                    <h1 class="h1-destinos">
                        Encuentra destinos para conocer Perú
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card card-new" style="width: 18rem;">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="text-card text-center">Ciudad que vio nacer a su homónima bebida</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card card-new" style="width: 18rem;">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="text-card text-center">La exótica selva peruana</p>
